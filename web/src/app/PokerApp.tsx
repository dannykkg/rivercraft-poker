    ...
    <section className="relative flex min-h-[720px] flex-col overflow-hidden rounded-[28px] border border-white/8 bg-[#0b1311] p-4 lg:min-h-[calc(100vh-104px)] lg:p-6">
      ...
      <div className="relative z-10 mx-auto mt-16 aspect-[1.72/1] w-[82%] max-w-[1120px] rounded-[46%] border-[10px] border-[#281e18] bg-[#124334] shadow-[inset_0_0_0_2px_rgba(255,255,255,.08),inset_0_0_90px_rgba(0,0,0,.5),0_36px_70px_rgba(0,0,0,.46)] sm:mt-20 sm:w-[90%]">
        ...
        {tableSeats.map((player, visualSeat) => {
          ...
          return <div key={player.id} data-table-seat={visualSeat + 1} data-player-id={player.id} data-seat-state={seatState} style={{ left: `${position.left}%`, top: `${position.top}%` }} className={`absolute min-w-[132px] -translate-x-1/2 -translate-y-1/2 rounded-2xl border p-2.5 shadow-xl ring-1 ring-inset ring-black/15 backdrop-blur transition sm:min-w-[156px] sm:p-3 ${winner ? "winner-seat border-amber-100 bg-[#f1d58c] shadow-[0_0_36px_rgba(253,230,138,.52)] ring-2 ring-amber-100/70" : displayEliminated ? "border-dashed border-zinc-500 bg-[#858078] grayscale shadow-none" : player.folded ? "border-dashed border-zinc-500 bg-[#b4ada2] grayscale shadow-none" : isCurrent ? "border-amber-50 bg-[#f6cf72] shadow-[0_0_38px_rgba(253,230,138,.55)] ring-2 ring-amber-100/80" : isHero ? "border-amber-100 bg-[#f2dfb7] shadow-[0_14px_32px_rgba(0,0,0,.48),0_0_22px_rgba(251,191,36,.28)]" : "border-white bg-[#e9e1d4] shadow-[0_14px_32px_rgba(0,0,0,.48),0_0_16px_rgba(255,255,255,.18)]"}`}>
